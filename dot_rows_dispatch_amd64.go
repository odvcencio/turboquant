...
// dotFloat32Rows4 computes 4 row dot products against vec using the
// hand-written SSE kernel. A goexperiment.simd build uses the simd-package
// kernel instead; see dot_rows_simd_amd64.go.
